...
import com.alura.ForoHub.domain.topic.validation.UpdateValidation;
import com.alura.ForoHub.domain.topic.validation.ValidationTopical;
import com.alura.ForoHub.domain.user.User;
import com.alura.ForoHub.domain.user.UserRepository;
import com.alura.ForoHub.infra.error.IntegrityValidation;
